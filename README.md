...
- **Módulo Restaurante (Ajustes → Restaurante, se activa por módulos):** plano de mesas por salón (arrastrar, formas, puestos) con estados libre / ocupada / pidiendo la cuenta; cuenta abierta por mesa con personas y mesero, comandas a cocina por tandas (solo lo nuevo), precuenta con propina sugerida, cambiar o unir mesas; pedidos para llevar a nombre del cliente con tablero pendiente → en preparación → listo → entregado; domicilios con cliente por teléfono, dirección, piso/apto y barrio, repartidor, tiempo estimado, costo de envío, cobro contra entrega o por plataforma (Rappi/DiDi) y cuadre por repartidor; monitor de cocina (KDS) por estaciones; cobro con descuento y motivo, propina, uno o dos medios de pago, plataforma y a crédito (por cobrar); caja obligatoria opcional; reportes por tipo de venta, canal, mesero (promedio por persona) y repartidor.
